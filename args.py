...
def get_parser():
    ...
    # Data directories
    parser.add_argument(
        "--data_dir", type=str, default="./custom_pipeline/splits/all_data_test.json"
    )
    parser.add_argument(
        "--video_feature_dir", type=str, default="./custom_pipeline/eva_clip_features"
    )
    parser.add_argument("--asr_dir", type=str, required=False)
    parser.add_argument("--asr_feature_dir", type=str, required=False)

    # Tasks
    parser.add_argument("--task_moment_retrieval", action="store_true", default=True)
    parser.add_argument("--task_moment_segmentation", action="store_true", default=True)
    parser.add_argument("--task_step_captioning", action="store_true", default=True)
    ...
    # moment retrieval
    parser.add_argument(
        "--moment_segmentation_difference_threshold", type=float, default=0.50
    )
    ...
    parser.add_argument(
        "--save_feats", action="store_true", help="save video features to disk"
    )
